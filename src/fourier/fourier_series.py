...
class FourierCirclesScene(Scene):
    ...
    def setup(self):
        ...
        # config = {**FourierCirclesScene.CONFIG, **type(self).CONFIG}
        ...
        console.log('vector_clock: ', self, self.vector_clock)
...
class FourierOfTexPaths(FourierOfPiSymbol):
    ...
    def construct(self):
        name = MathTexText(self.animated_name)
...
class FourierOfTrebleClef(FourierOfPiSymbol):
    ...
    def setup(self):
      super().setup()
      config = {**FourierOfTrebleClef.CONFIG, **type(self).CONFIG}
      for key, value in config.items():
          setattr(self, key, value)
    ...
    def get_shape(self):
        svg_path = script_dir / self.file_name
...
class ExplainCircleAnimations(FourierCirclesScene):
    ...
    def setup(self):
        super().setup()
        self.n_vectors = 100
        self.center_point = 2 * DOWN
        self.n_top_circles = 9
        self.path_height = 3
    def construct(self):
        self.add_path()
        self.add_circles()
    ...
    def add_circles(self):
        ...
        self.circles = self.get_circles(coefs)
    ...
    def show_frequencies(self):
        ...
        freq_word = MathTexText("Frequencies")
        freq_word.scale(1.5)
